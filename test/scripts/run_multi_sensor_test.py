...
for indx in range(0, number_of_sensors):
    ...
    if indx < number_of_sensors - 1:
        subprocess.Popen("./sensor --file-to-send \"../../../payloads/meter_reading_1_compact.json\" --use-lorawan-rest-api >> run_multi_sensor_test.log", cwd=sensor_test_folder, shell=True)
    else:
        subprocess.run("./sensor --file-to-send \"../../../payloads/meter_reading_1_compact.json\" --use-lorawan-rest-api > run_multi_sensor_test.log", cwd=sensor_test_folder, shell=True)
